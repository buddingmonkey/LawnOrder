    ...
    public class TileMapInspector : Editor
    {
        ...
        private void initTileLayerList()
        {
            ...
            tileLayerList.drawElementCallback = (Rect rect, int index, bool isActive, bool isFocused) =>
            {
                ...
                tileLayer.gameObject.SetActive(EditorGUI.Toggle(new Rect(rect.x, rect.y, toggleButtonW, EditorGUIUtility.singleLineHeight), GUIContent.none, tileLayer.gameObject.activeInHierarchy));
        ...
        private void HandlePaintTool(Event e)
        {
            ...
            if (e.button == 0 && (e.type == EventType.MouseDrag || e.type == EventType.MouseDown))
            {
                ...
                if (tileMap.IsInTileMap(mousePosition))
                {
                    ...
                    {
                        GameObject go = TileEditorUtility.CreateTile(new Vector3(pos.x, pos.y, 0), tileData, tileLayer.Alpha / 255.0f, tileLayer.SortingLayer);
